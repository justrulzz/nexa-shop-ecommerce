              ...
              <div className="brand-info">
                ...
                <div className="footer-desc">
                  ...
                  <p style={{ marginTop: "15px", lineHeight: "1.6" }}>
                    Discover the latest trends and quality products with
                    NexaShop. We prioritize customer satisfaction, and we're
                    here to provide a reliable and fast shopping experience.
                  </p>
                </div>
                <div className="footer-contact">
                  <p>
                    {}
                    <a href="tel:+905538891620">(+90) 553 889 16 20</a> -{" "}
                    <a href="mailto:smtgulhan661@gmail.com">
                      smtgulhan661@gmail.com
                    </a>
                  </p>
                </div>
              </div>
          ...
          <div className="container">
            <div className="footer-copyright">
              <div className="site-copyright">
                <p>
                  Copyright 2026 © E-Commerce Theme. All right reserved. Powered
                  by Samet Gülhan
                </p>
              </div>
              <a href="#">
