// Select bileşenini buraya ekledik
import { Button, Form, Input, InputNumber, message, Spin, Select } from "antd";
...
const CreateProductPage = () => {
  ...
  const onFinish = async (values) => {
    ...
    setLoading(true);
    try {
      // Endpoint'i ve mesajları ürün (product) oluşturmaya uygun hale getirdim
