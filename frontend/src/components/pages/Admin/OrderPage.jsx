...
const columns = [
    {
      ...
      // Eğer Stripe'tan email gelirse onu yaz, gelmezse senin mail adresini bas
      render: (text) => <b>{text ? text : "smtgulhan661@gmail.com"}</b>,
    },
    {
      title: "Sipariş Fiyatı",
      dataIndex: "amount",
      // Fiyatları kuruş formatından çıkarıp dolara çeviriyoruz
      render: (amount) => (
